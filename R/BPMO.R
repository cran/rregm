  ...
  structure(
    ...
    list(
      ...
      dldm = function(y, mu, sigma)
      {
        ...
        (sigma+1)*
          (log(y)-log1p(y)-digamma(alpha)+digamma(alpha+beta))
      },
      ...
      d2ldm2 = function(y, mu, sigma)
      {
        ...
        -(sigma+1)^2*
          (trigamma(alpha)-trigamma(alpha+beta))
      },
