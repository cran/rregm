summary.rregm = function (object, ...) 
{
    ...
    tipo = switch(object$param, AM = "mean", HM = "harmonic mean", 
        GM = "geometric mean", MO = "mode", MD = "median", LL="classical parameterization",
		LL2="proportional odds", LL3="mean", LL4="harmonic mean", LL5="mode", LL6="quantile")
    model = switch(object$dist, BE = "beta", GA = "gamma", IG = "inverse gamma", 
		...
		LL4="log-logistic", LL5="log-logistic", LL6="log-logistic", LN="log-normal")
    cat("-------------------------------------------------------------------------\n")
